...
const FAQ_ITEMS: FaqItem[] = [
  {
    q: "Quelle fiscalite s'applique aux dividendes en 2026 ?",
    a: "Par defaut, les dividendes sont soumis au PFU (Prelevement Forfaitaire Unique) de 30% = 12,8% d'impot sur le revenu + 17,2% de prelevements sociaux. Cette flat tax est prelevee a la source par l'etablissement payeur. L'alternative : opter pour le bareme progressif de l'IR qui applique un abattement de 40% avant imposition a la TMI + 17,2% PS sur le brut. L'option bareme est GLOBALE (applicable a tous les revenus de capitaux mobiliers de l'annee).",
  },
  {
    q: "Quand choisir le bareme progressif plutot que le PFU ?",
    a: "Le bareme est plus avantageux si votre TMI est faible (0%, 11%) car l'abattement de 40% + la TMI + PS est inferieur au PFU 30%. Exemple : TMI 11%, dividendes 10 000 EUR : bareme = (10 000 x 60% x 11%) + (10 000 x 17,2%) = 660 + 1 720 = 2 380 EUR (24%) vs PFU 3 000 EUR (30%). A partir de TMI 30%, le PFU est quasi-toujours plus avantageux. Toujours simuler avant de choisir.",
  },
  {
    q: "Dividendes ou remuneration : que choisir en tant que dirigeant ?",
    a: "Remuneration : deductible du benefice IS (baisse l'IS) mais soumise aux charges sociales URSSAF (~75% en SAS, ~45% en EURL/SARL gerant majoritaire TNS) et a l'IR sur le revenu. Dividendes : non deductibles de l'IS (25% ou 15% PME) mais soumis au PFU 30% (+cotisations TNS si gerant majoritaire SARL/EURL au-dela de 10% du capital). Regle generale : en SAS avec IS 25%, optimisation par remuneration jusqu'a couvrir la remuneration minimum, puis dividendes. En SARL, la remuneration est souvent preferable car le regime TNS est moins couteux que le regime general.",
  },
  {
    q: "Qu'est-ce que la regle des 10% pour les dividendes de gerant majoritaire ?",
    a: "Pour les gerants majoritaires de SARL/EURL (ou assimiles TNS), la part des dividendes depassant 10% du capital social + primes d'emission + soldes moyens annuels des comptes courants d'associe est soumise a cotisations sociales TNS (~25-40% selon les tranches). Exemple : capital 10 000 EUR, dividendes 50 000 EUR : 1 000 EUR au-dessus de 10% = 49 000 EUR soumis a cotisations (+ environ 10 000 EUR de charges sociales supplementaires). Cette regle ne s'applique PAS aux presidents de SAS (affilies au regime general).",
  },
];

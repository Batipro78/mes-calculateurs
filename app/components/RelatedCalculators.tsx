...
const RELATED_MAP: Record<string, string[]> = {
  ...
  "/calcul-consommation-electrique": ["/calcul-surface-peinture", "/calcul-pourcentage", "/simulateur-epargne", "/calcul-tva", "/simulateur-blackout"],
  ...
  "/prix-electricien": ["/calcul-consommation-electrique", "/prix-macon", "/prix-plombier", "/prix-couvreur", "/prix-travaux-maison"],

...
export default function CalculateurSalairePlenit() {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-5">
            ...
            <button
              ...
              className={`flex-1 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all ${
                direction === "brut-vers-net"
                  ? "bg-white text-[#3A4856] shadow-sm"
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full border border-slate-300 rounded-xl px-4 py-3.5 text-xl font-semibold pr-12 focus:outline-none focus:ring-2 focus:ring-[#F39200] focus:border-[#F39200] transition-shadow"
              min="0"
              step="100"
            />
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      statut === s ? "border-[#F39200]" : "border-slate-300"
                    }`}
                  >
                    {statut === s && (
      ...
      <div className="lg:col-span-2 space-y-4">
        <div className="bg-gradient-to-br from-[#32B7BB] to-[#00A19A] text-white rounded-2xl p-6 shadow-lg shadow-teal-200/60">
          <p className="text-sm text-teal-50 mb-1">Salaire net mensuel</p>
          <p className="text-4xl font-extrabold tracking-tight">
            {fmt(netMensuel)} <span className="text-lg font-semibold">EUR</span>
          </p>
          <div className="h-px bg-white/20 my-4" />
          <div className="flex justify-between text-sm">
            <span className="text-teal-100">Net annuel</span>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <p className="text-2xl font-extrabold text-[#3A4856]">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <p className="text-xl font-extrabold text-[#F39200]">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold text-[#F39200]/80">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
          ...
          <div className="flex h-3 rounded-full overflow-hidden">
            <div
              className="bg-gradient-to-r from-[#32B7BB] to-[#00A19A] transition-all duration-500"
              style={{ width: `${100 - taux}%` }}
            />
            <div
              className="bg-[#F39200] transition-all duration-500"
              style={{ width: `${taux}%` }}
            />
          </div>
          <div className="flex justify-between text-xs mt-2">
            <span className="text-[#00A19A] font-medium">
              Net ({100 - taux}%)
            </span>
            <span className="text-[#F39200] font-medium">
              Cotisations ({taux}%)
            </span>
          </div>
        </div>

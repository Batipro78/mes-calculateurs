...
import { PRESTATIONS_CHAUFFAGISTE, REGIONS_SEO, parseSlugChauffagiste, generateAllSlugsChauffagiste, calculerPrixChauffagiste, fmtPrix } from "../calcChauffagiste";

export function generateStaticParams() {
  return generateAllSlugsChauffagiste().map(s => ({ params: s }));
}
